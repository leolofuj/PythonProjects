...
class Tetris:
    ...
    nextBlock=None
    game_speed = " "
    velocity_blck = 1 #Controls the block velocity
    ...
    while not done:
        ...
        for i in range(game.height):
            for j in range(game.width):
                pygame.draw.rect(screen, '#838784', [game.x + game.zoom * j, game.y + game.zoom * i, game.zoom, game.zoom], 1)
                if game.field[i][j] > 0:
        ...
        text_speed = font.render("Game Speed: {}".format(game_speed), True, '#000000')
...
pygame.display.set_caption("Tetris by DataFlair@ implemented @Leonardo")
run = True
while run:
    screen.fill((16, 57, 34 ))
    font = pygame.font.SysFont("Calibri", 70, bold=True)
    font2 = pygame.font.SysFont("Calibri", 50, bold=True)
    font3 = pygame.font.SysFont("Calibri", 30, bold=True)
    label = font.render("Tetris Game", True, '#FFFFFF')
    label2 = font2.render("Game Level: ", True, '#FFFFFF')
    label_easy = font3.render("Easy / press any ", True, '#FFFFFF')
    label_medium = font3.render("Medium / press 2 ", True, '#FFFFFF')
    label_hard = font3.render("Hard / press 3 ", True, '#FFFFFF')
   
    screen.blit(label, (10, 180 ))
    screen.blit(label2, (10, 280 ))
    screen.blit(label_easy, (40, 340 ))
    screen.blit(label_medium, (40, 380 ))
    screen.blit(label_hard, (40, 420 ))
    pygame.display.update()
    #TODO Implement the game Gui Themes choice methody
